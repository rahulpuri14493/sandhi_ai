...
All SQL migrations live here. **Run in order** (001 → 014) when setting up or updating the database. Each file is idempotent where possible (`IF NOT EXISTS`, `IF EXISTS`).
